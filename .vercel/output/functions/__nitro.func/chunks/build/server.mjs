import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, defineAsyncComponent, computed, isRef, ref, defineComponent, unref, h, Suspense, nextTick, mergeProps, provide, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { x as createHooks, y as getContext, c as createError$1, z as toRouteMatcher, A as createRouter, t as defu, B as hasProtocol, m as joinURL, C as withQuery, D as sanitizeStatusCode, E as isScriptProtocol, F as executeAsync, G as defuFn, H as klona } from '../nitro/nitro.mjs';
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyContentList = defineAsyncComponent(() => import('./ContentList.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyMarkdown = defineAsyncComponent(() => import('./Markdown.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyProseCode = defineAsyncComponent(() => import('./ProseCode.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline.vue2.mjs').then((r) => r["default"] || r.default || r));
...
export { _export_sfc as _, useRoute as a, useRuntimeConfig as b, createError as c, useState as d, useRouter as e, useNuxtApp as f, nuxtLinkDefaults as g, asyncDataDefaults as h, useAppConfig as i, navigateTo as n, resolveRouteObject as r, server as s, useHead as u };
