<template>
    ...
    <!-- Projects Section -->
    <div class="projects">
        <ContentList path="/case-studies" :where="{ order: { $in: [1, 2] } }" :sort="{ order: 1 }" v-slot="{ list }">
            <div class="row-1">
                ...
                <div v-else class="case-study-item" v-for="caseStudy in list">
                    <a :href="`/case-studies/${caseStudy.slug}`">
                        <div class="case-study-id">
        ...
        <ContentList path="/case-studies" :where="{ order: 3 }" v-slot="{ list }">
            <div class="row-2">
                <div class="case-study-item-lg" v-for="caseStudy in list">
                    <a :href="`/case-studies/${caseStudy.slug}`">
                        <div class="case-study-id">
                            <div>0{{ caseStudy.order }}</div>
                            <div class="case-study-title"> {{ caseStudy.title }}</div>
        ...
        <ContentList path="/projects" :where="{ order: { $in: [4, 5] } }" :sort="{ order: 1 }" v-slot="{ list }">
            <div class="row-3">
                ...
                <div v-else class="project-item" v-for="project in list">
                    <a :href="`/projects/${project.slug}`">
                        <div class="project-id">
